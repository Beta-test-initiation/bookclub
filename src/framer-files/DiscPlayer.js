 ...
 */
export default function DiscPlayer(props) {
    const {
        audioFile = "https://framerusercontent.com/assets/8w3IUatLX9a5JVJ6XPCVuHi94.mp3", backgroundColor = "#FFFFFF", discColor = "#333333", discImage, needleDotColor = "#FF5588", style
    } = props;
    ...
    useEffect(() => {
        ...
        if (isPlaying) {
            ...
            discControls.set({
                rotate: discRotationRef.current
            });
            needleControls.start({
                rotate: 15,
                transition: {
    ...
    }, [isPlaying, discControls, needleControls, isStatic]);
...
addPropertyControls(DiscPlayer, {
    audioFile: {
...
//# sourceMappingURL=./DiscPlayer.map